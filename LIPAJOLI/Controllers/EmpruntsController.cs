...
namespace LIPAJOLI.Controllers
{
    public class EmpruntsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Emprunts.Include(e => e.Livre).Include(e => e.Usager);
        ...
        {
            ViewData["LivreCode"] = new SelectList(_context.Livres, "Code", "Code");
            ViewData["UsagerNoAbonne"] = new SelectList(_context.Usagers, "NoAbonne", "NoAbonne");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DateEmprunt,DateLimiteRetour,DateRetour,LivreCode,UsagerNoAbonne")] Emprunt emprunt)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DateEmprunt,DateLimiteRetour,DateRetour,LivreCode,UsagerNoAbonne")] Emprunt emprunt)
        {
            if (id != emprunt.Id)
            {
                return NotFound();
